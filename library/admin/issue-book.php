...
if(strlen($_SESSION['alogin'])==0) {   
    ...
    if(isset($_POST['issue'])) {
        ...
        $bookid = $_POST['bookid'];
        $returnDate = $_POST['returnDate']; // Get the return date input
        $isissued = 1;

        // Update SQL to include return date
        ...
        $query->bindParam(':returnDate', $returnDate, PDO::PARAM_STR); // Bind return date
